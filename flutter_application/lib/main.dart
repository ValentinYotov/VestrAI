...
class _HomeScreenState extends State<HomeScreen> {
  double _budget = 0;
  double _riskLevel = 1; // 1 = нисък, 2 = среден, 3 = висок
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                // Тук по-късно ще добавим логиката за предложения
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(content: Text('Покажи предложения за $_budget лв, риск: ${_riskLevel.round()}')),
                );
              },
